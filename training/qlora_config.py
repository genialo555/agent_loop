...
class QLoRAConfig:
    ...
    # Model configuration
    model_name: str = "google/gemma-2-2b"  # Default to Gemma 2B for RTX 4090
    ...
    # Power Management (RTX 4090: 90% perf at 55% power)
    cuda_power_limit: Optional[int] = 220   # 55% of 400W
    ...
    def setup_power_management(self) -> None:
        ...
        if self.cuda_power_limit:
            ...
            print(f"🔋 GPU power limit set to {self.cuda_power_limit}W (55% for efficiency)")
